...
public class SongListActivity extends ToolbarActivity {
    ...
    private final String getSongListUrl= ipAddressUtil.serviceIp+"/typeSongList/getSongList";
    ...
    private void getBundle(){
        ...
        songListName=getIntent().getStringExtra("name");
    }
    ...
    private void initRecyclerView(){
        ...
        adapter.setClickMoreListener(new OnClickMoreListener() {
            ...
            public void onMoreClick(int position) {
                MusicMoreInfoPopup popup=new MusicMoreInfoPopup(SongListActivity.this);
                popup.setMorePopUp();
                popup.showMorePopUp(onlineMusicList.get(position));
            }
        });
    ...
    private void loadSongListMusic(){
        ...
        HttpUtil.sendOkHttpRequest(getSongListUrl,body, new Callback() {
            @Override
