package com.rex.easymusic.PlayerEngine;
...
import static com.rex.easymusic.service.PlayerService.pauseAction;
import static com.rex.easymusic.service.PlayerService.plyingAction;
...
public class PlayerEngine extends MediaPlayer implements MediaPlayer.OnPreparedListener,MediaPlayer.OnCompletionListener {
    ...
    public PlayerEngine(PlayerService service) {
        super();
